...
Make_triple_integrator_circuit <- function(cinput1, cinput2, cinput3, cinput4) {
  ...
  intg_gate1_oy <- Make_Integrator_OishiYordanov('intg1', 'Up', 'Un',
                                                 'Xp', 'Xn', cinput1, cinput2, 1e-3)
  intg_gate2_oy <- Make_Integrator_OishiYordanov('intg2', 'Vp', 'Vn',
                                                 'Yp', 'Yn', cinput3, cinput4, 1e-3)
  ...
  intg_gate5_add <- Make_Adder2In_Song('add1', 'Xp', 'Yp', 'Z', 0 , 0, 1000, 1e-3)
