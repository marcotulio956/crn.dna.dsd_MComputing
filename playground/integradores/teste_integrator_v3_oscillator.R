...
Make_triple_integrator_circuit <- function(cinput1, cinput2, cinput3, cinput4) {
  ...
  intg_gate01_osc <-Make_Oscillator_Dalchau('osc', 'Ap', 'Bp', 'Cp',
                                           10, 3, 4, 2e-3)


  intg_gate1_oy <- Make_Integrator_OishiYordanov('intg1', 'Ap', 'An',
                                                 'Xp', 'Xn', 0, 0, 1e-3)
  ...
  circuito <- DNArLogic::circuit_add_gate(circuito, intg_gate01_osc)
